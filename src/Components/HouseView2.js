...
export class HouseView2 extends Component {
    render() {
        return (
            <div>
                <SideBar />
                ...
                <div className="middle">
                    <Carousel>
                        <div className="image-slide">
                            <img src={H2P1} class="img-inside" />
                            <p className="legend" id="text-img">1375 Graymont Dr SW, Atlanta, GA 30310</p>
                        </div>
                        <div className="image-slide">
                            <img src={H2P2} class="img-inside" />
                            <p className="legend">3 bd, 3 ba, 1,580 sqft</p>
                        </div>
                        <div className="image-slide">
                            <img src={H2P3} class="img-inside" />
                            <p className="legend">Est. payment: $1,426/mo</p>
                        </div>
                    </Carousel>
                </div>
