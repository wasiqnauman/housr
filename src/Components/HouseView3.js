...
var houses = [
    ...
    },
    {
        ...
        bedrooms: 4,
        bathrooms: 2,
        images: [{ H3P3 }, { H3P2 }, { H3P3 }]
    }
];


export class HouseView3 extends Component {
    render() {
        return (
            <div>
                <SideBar />
                ...
                <div className="middle">
                    <Carousel>
                        <div className="image-slide">
                            <img src={H3P1} class="img-inside" />
                            <p className="legend" id="text-img">2363 Cross St NW, Atlanta, GA 30318</p>
                        </div>
                        <div className="image-slide">
